...
//  WLChatUI
//
//  Created by WangLei on 2019/7/20.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    WLSessionViewController *firstViewController = [[WLSessionViewController alloc] init];
    UINavigationController *firstNav = [[UINavigationController alloc] initWithRootViewController:firstViewController];
    
    WLUserViewController *secondViewController = [[WLUserViewController alloc] init];
