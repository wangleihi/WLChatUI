...
@implementation WLSessionTableViewCell {
...
- (void)setConfig:(WLChatSessionModel *)model {
    ...
    _notiImageView.image = [WLInputHelper otherImageNamed:@"WL_chat_bell_not"];
    _nameLabel.text = model.name;
    _messageLabel.text = lastMsg;
    _timeLabel.text = [WLChatHelper timeFromTimeStamp:[NSString stringWithFormat:@"%@",@(lastTimestamp)]];
