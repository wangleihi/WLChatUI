...
@implementation WLChatVoiceMessageCell {
...
- (void)setConfig:(WLChatMessageModel *)model isShowName:(BOOL)isShowName {
    ...
    if (model.isSender) {
        ...
        _voiceImageView.image = [WLInputHelper otherImageNamed:@"WL_chat_voice_2"];
        ...
        _voiceImageView.image = [WLInputHelper otherImageNamed:@"WL_chat_voice_1"];
