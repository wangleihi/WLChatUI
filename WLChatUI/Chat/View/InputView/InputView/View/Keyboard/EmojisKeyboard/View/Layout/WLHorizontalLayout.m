...
@implementation WLHorizontalLayout
...
- (id)initWithSpacing:(CGFloat)spacing rows:(NSInteger)rows nums:(NSInteger)nums {
    ...
    if (self) {
        ...
        _WLItemSize = CGSizeMake(itemWidth, itemHeight);
    }
    return self;
}
...
- (void)prepareLayout{
    ...
    CGFloat itemWidth = _WLItemSize.width;
    CGFloat itemHeight = _WLItemSize.height;
